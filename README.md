...
As a supplementary repository to our paper "Epistemic uncertainty in hazard modeling: a risk perspective at regional scale", we presented the figures with the with the expected dispersions by each of the 20 italian regions.
...
## In every figure we have 4 different panels described ni our paper. Every panel presents:
### a)
### b)
### c)
### d)
